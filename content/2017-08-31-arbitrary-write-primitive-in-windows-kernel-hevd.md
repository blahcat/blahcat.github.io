...
infoleak or else). Back in 2012, <i class="fa fa-twitter">{{ twitter(user="cesarcer") }}</i>  covered this very situation in his Black Hat
...
{{ twitter(user="d_olex") }} have explored this path as early as 2011 to use it as an exploit vector as Win7
