...
_Note_: for convenience, the following equivalence will be used throughout this post:
...
![](/img/950bbc05-e57e-4d49-96a4-9aefec9a8ef6.png){:width="750px"}
...
![](/img/5787cef5-11cc-4a1f-97b7-2f6533812b2d.png){:width="500px"}

_Note_: a better version was done by {% include icon-twitter.html username="@msuiche" %} [here](#link_3)
...
Links to resources I couldn't understand anything without.
 ...
 - <a name="link_4">[4]</a> [Dumping Windows Credentials - {% include icon-twitter.html username="@lanjelot" %} ](https://pure.security/dumping-windows-credentials/)
