...
> 
> **Note**: Earlier this week, I was notified by {% include icon-twitter.html username="mehqq_" %} that this is OOB read is a different bug. I will post an update soon showcasing the actual bug instead. My bad for the confusion.
>
